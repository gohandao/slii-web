            ...
            >
              <Link href={`/${creator.username}`} as={`/${creator.username}`}>
                <a className="relative flex flex-col border border-gray-800 rounded-lg w-full items-center shadow-lg bg-gray-800 overflow-hidden">
                  <div
                    className={`absolute flex justify-center items-center gap-2 left-0 top-0 py-[2px] px-3 z-10 rounded-br-lg text-xs md:text-xs capitalize ${
                  ...
                  <div className="absolute right-1 top-[1px] z-10">
                    <AiOutlineHeart className="text-xl text-gray-200 opacity-50" />
                  </div>
                  <div className="flex relative w-full h-[72px] overflow-hidden bg-gray-100">
